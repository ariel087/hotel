	...
	if (isset($_POST['submit'])) {
		...
		if ($checkindate < $cdate) {
			...
			if ($checkAvailabilityQuery->rowCount() > 0) {
				...
				$sql = "INSERT INTO tblbooking(RoomId, BookingNumber, UserID, IDType, Gender, Address, CheckinDate, CheckoutDate, downPay, pool, food) 
						VALUES(:rid, :booknum, :uid, :idtype, :gender, :address, :checkindate, :checkoutdate, :downPay, :pool,:food)";
				...
				$query->bindParam(':pool', $pool, PDO::PARAM_STR);
...
<tr><td><br><h5>With Pool</h5>

								 <p style="text-align: left;"> <input type="radio"  name="pool" id="pool" value="2500" checked="true">Yes</p>

								 

                                 <p style="text-align: left;"> <input type="radio" name="pool" id="pool" value="0">No</p>
<tr><td><br><h5>With Food</h5>

								 <p style="text-align: left;"> <input type="radio"  name="food" id="food" value="2500" checked="true">Yes</p>

								 

                                 <p style="text-align: left;"> <input type="radio" name="food" id="food" value="0">No</p>
								 </td></tr></th></table>
