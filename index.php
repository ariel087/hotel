					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4 style="text-shadow: 3px 3px black;">AMETHYST HOTEL</h4>
									<h3>We know what you love</h3>
										<p style="color:white;">Welcome to our hotel</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:amthysthotel@gmail.com">amthysthotel@gmail.com</a></p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 amthysthotel . All Rights Reserved | Design by <a href="index.php">ROY</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
