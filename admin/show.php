...
$sql = "SELECT b.*, u.FullName, u.Email AS UserEmail, u.MobileNumber, r.RoomName, r.NoofBed
        FROM tblbooking b
...
while ($row = mysqli_fetch_array($re)) {
    ...
    $bed_type = $row['NoofBed'];
    $cin_date = $row['CheckinDate'];
    $cout_date = $row['CheckoutDate'];

    // Calculate the number of days
    $start_date = new DateTime($cin_date);
    $end_date = new DateTime($cout_date);
...
?>
		...
		<article>
			...
			<address >
				...
				<p><br></p>
				<p>Customer Name  : -  <?php echo $title?><br></p>
			</address>
			<table class="meta">
				<tr>
