...
<div class="row">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        // Adjust the conditions based on your actual category names
        if ($categoryName == 'Deluxe Room') {
            echo "<div class='panel-footer back-footer-blue'>" . $categoryName . "</div>";
        } elseif ($categoryName == 'Luxury Room') {
            echo "<div class='panel-footer back-footer-green'>" . $categoryName . "</div>";
        } elseif ($categoryName == 'Standard Room') {
            echo "<div class='panel-footer back-footer-brown'>" . $categoryName . "</div>";
        } else {
            // Handle other categories if needed
            echo "<div class='panel-footer back-footer-red'>" . $categoryName . "</div>";
        }
