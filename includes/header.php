		...
		<div class="container">
			<nav class="navbar navbar-default">
                ...
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<h1><a class="navbar-brand" href="index.php"><img style="height:70px;width 70px;position:absolute;margin-left:-40px;"src="admin/images/<?php echo $logoImage; ?>">AMETHYST <span>HOTEL</span><p class="logo_w3l_agile_caption"> Discover Tranquil Elegance</p></a></h1>
				</div>
